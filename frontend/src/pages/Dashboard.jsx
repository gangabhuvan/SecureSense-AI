    ...
    <div className="dashboard-page">
      ...
      <section className="dashboard-header">
        <div>
          ...
          <p>
            ...
            multimodal intelligence and explainable evidence.
          </p>
        </div>
      ...
      <section className="dashboard-platform-banner">
        ...
        <div className="dashboard-platform-copy">
          ...
          <p>
            Backend API, trained NLP intelligence and
            durable evidence services are monitored live.
          </p>
        </div>
      ...
      <section className="dashboard-section">
        <div className="dashboard-section-heading">
          <div>
            ...
            <h2>Latest Security Investigation</h2>
            <p>
        ...
        <div className="dashboard-section">
          <div className="dashboard-section-heading">
            <div>
              ...
              <p>
                Integrated SecureSense intelligence stack.
              </p>
            </div>
          ...
          <div className="dashboard-capability-list">
            <div>
              <Brain size={15} />
              <span>NLP Security Analysis</span>
              <strong>Active</strong>
            </div>

            <div>
              <Eye size={15} />
              <span>Visual Phishing Intelligence</span>
              <strong>Integrated</strong>
            </div>

            <div>
  <Brain size={15} />
  <span>Communication Intent Intelligence</span>
  <strong>Integrated</strong>
</div>

<div>
  <ShieldCheck size={15} />
  <span>Evidence-Based Consensus</span>
  <strong>Integrated</strong>
</div>
        ...
        <strong>Integrated</strong>
            ...
            <div>
              <Database size={15} />
              <span>Explainable Evidence Ledger</span>
